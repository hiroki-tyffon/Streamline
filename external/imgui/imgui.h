...
namespace ImGui
{
    ...
    #ifdef IMGUI_NVIDIA
    IMGUI_API bool          IsItemIDActive(ImGuiID item_id);                                    // is item with specific id active?
    #endif
...
#ifdef IMGUI_NVIDIA
    ImGuiHoveredFlags_TreeArrowOnly                 = 1 << 8,
#endif
...
#ifdef IMGUI_NVIDIA
    ImGuiStyleVar_DockSplitterSize,    // float     DockSplitterSize
#endif
    ImGuiStyleVar_COUNT
